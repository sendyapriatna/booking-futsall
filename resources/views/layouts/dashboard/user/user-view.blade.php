                    ...
                    <div class="row">
                        <div class="col m-3">
                            <div class="d-flex justify-content-end">
                                <form action="/dashboard/user/cari" class="form-inline" method="post">
                                    @csrf
                                    ...
                                    <a href="{{ url('/dashboard/user/create') }}" class="btn btn-primary">Add Data</a>
                                </form>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class=" row">
                                                ...
                                                <a href="/dashboard/user/edit/{{ $item2->id}}" style="border-radius: 0.5em;" class="btn btn-warning mr-1"><i class="fa-solid fa-pen-to-square"></i></a>
                                                <a href="/dashboard/user/delete/{{ $item2->id}}" style="border-radius: 0.5em;" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                                            </div>
                                        </td>
                                        <!-- <td>
