                        ...
                        <div class="col m-3">
                            <div class="d-flex justify-content-end">
                                <form class="form-inline">
                                    ...
                                    <a href="{{ url('/dashboard/lapangan/create') }}" class="btn btn-primary">Add Data</a>
                                </form>
                            </div>
                        </div>
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            ...
                            <table class="table-striped mb-0 table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="max-width: 500px;">{{$item2->deskripsi}}</td>
                                        <td>{{$item2->harga}}</td>
                                        ...
                                        <td>
                                            <div class=" row">
                                                ...
                                                <a href="/dashboard/lapangan/edit/{{ $item2->id}}" style="border-radius: 0.5em;" class="btn btn-warning mr-1"><i class="fa-solid fa-pen-to-square"></i></a>
                                                <a href="/dashboard/lapangan/delete/{{ $item2->id}}" style="border-radius: 0.5em;" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                                            </div>
                                        </td>
                                        <!-- <td>
                            ...
                            <div class="d-flex justify-content-center">
                                <h6 class="m-3">{{ $lapangan_tables->links('pagination::bootstrap-4') }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
